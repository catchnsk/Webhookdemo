package com.webhookdemo.config;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "webhook-consumer-group");
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.webhookdemo.dto");
        props.put(JsonDeserializer.USE_TYPE_INFO_HEADERS, false);
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.webhookdemo.dto.WebhookNotificationDto");
    ...
    public NewTopic webhookNotificationsTopic() {
        return TopicBuilder.name(webhookNotificationsTopic)
                .partitions(3)
                .replicas(1)
                .build();
    }
    ...
    public NewTopic webhookRetriesTopic() {
        return TopicBuilder.name(webhookRetriesTopic)
                .partitions(3)
                .replicas(1)
                .build();
    }
